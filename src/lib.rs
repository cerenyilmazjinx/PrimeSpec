...
#[derive(Debug)]
pub struct PrimeSpecProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeSpecProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeSpec processing");
    
    let mut processor = PrimeSpecProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeSpecProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeSpecProcessor::new(false);
